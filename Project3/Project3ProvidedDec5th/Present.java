...
public class Present extends Actor
{
    ...
    public void act() 
    {
        ...
        {   
            peeks++; //increases by 1 when the mouse is being clicked on this Present
            String[] a = new String[3];
            //   pop up a tool tip with three lines, one for height, one for width and one for peeks.       
            a[0]="Height: "+ getHeight(); 
            a[1]="Width: " + getWidth();            
            a[2]="Peeks: " + getPeeks();
            ToolTip toolTip = new ToolTip(a, 75);//The tool tip should "live" for 75 act calls.   
            MyWorld w = (MyWorld) this.getWorld();
            w.addObject(toolTip, this.getX(), getY());//tool tip should appear where the Present is located.         
        }
    }      
}
